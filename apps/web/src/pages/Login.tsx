...
export function Login() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex">
      {/* ── Left Hero Panel (lg+) ── */}
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center p-12">
        {/* Decorative blurred circles */}
        <div className="absolute -top-24 -left-24 h-96 w-96 rounded-full bg-blue-200/40 blur-3xl" />
        <div className="absolute bottom-12 right-0 h-80 w-80 rounded-full bg-indigo-200/40 blur-3xl" />
        <div className="absolute top-1/2 left-1/3 h-64 w-64 rounded-full bg-purple-200/30 blur-3xl" />
        ...
        <div className="relative z-10 max-w-lg animate-in fade-in slide-in-from-left-8 duration-700">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-xl font-bold text-gray-900">JobScout Pro</span>
          </div>
          ...
          <div className="mt-10 grid gap-5">
            {features.map((f) => (
              <div key={f.title} className="flex items-start gap-3 group">
                <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-white shadow-sm border border-gray-100 text-base group-hover:scale-110 transition-transform">
                  {f.icon}
                </span>
                <div>
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md animate-in fade-in slide-in-from-right-8 duration-700">
          ...
          <div className="flex items-center justify-center gap-2 mb-8 lg:hidden">
            ...
            <span className="text-lg font-bold text-gray-900">JobScout Pro</span>
          </div>
          ...
          <Card className="border-0 shadow-xl shadow-gray-200/50 backdrop-blur-sm bg-white/80">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-10 h-11 bg-gray-50/50 border-gray-200 focus-visible:ring-blue-500 focus-visible:border-blue-500 transition-colors"
                    />
                  </div>
                </div>
                ...
                {/* Error alert */}
                {error && (
                  <div className="flex items-center gap-2 rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700 animate-in fade-in slide-in-from-top-2 duration-300">
