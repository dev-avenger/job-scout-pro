...
export const BUILTIN_TEMPLATES: BuiltInTemplate[] = [
  ...
  },
  {
    ...
    region: 'general',
    description:
      'Two-column engineering CV: tinted sidebar for skills, languages and certifications; experience and projects lead the main column. Indigo accent, A4.',
    isBuiltIn: true,
    version: 1,
    config: makeTemplate({
      layout: 'modern',
      ...
      pageRows: modernSidebarPageRows(),
      pageFormat: 'a4',
      spacing: { marginPt: 40, sectionGapPt: 13, entryGapPt: 7 },
      dateFormat: 'MM/YYYY',
    }),
  },
  {
    ...
    region: 'general',
    description:
      'Senior/executive single column: centered serif name, uppercase ruled headings, generous spacing, restrained navy palette. Summary and experience lead.',
    isBuiltIn: true,
    version: 1,
    config: makeTemplate({
      layout: 'classic',
      ...
      pageFormat: 'a4',
      spacing: { marginPt: 58, sectionGapPt: 16, entryGapPt: 8 },
      dateFormat: 'MM/YYYY',
    }),
  },
  {
    ...
    region: 'general',
    description:
      'Full academic CV: single column with education and publications emphasized, understated serif headings, A4, multi-page friendly.',
    isBuiltIn: true,
    version: 1,
    config: makeTemplate({
      layout: 'minimal',
      ...
      pageFormat: 'a4',
      spacing: { marginPt: 55, sectionGapPt: 15, entryGapPt: 8 },
      dateFormat: 'MM/YYYY',
    }),
  },
  {
    slug: 'compact-onepage',
    name: 'Compact One-Page',
    region: 'general',
    description:
      'Dense single-page resume: tight margins and spacing, smaller type, two-column skills — built to fit a strong profile on one Letter page.',
    isBuiltIn: true,
    version: 1,
    config: makeTemplate({
      layout: 'minimal',
      ...
      sectionColumns: { skills: 2 },
      pageFormat: 'letter',
      spacing: { marginPt: 32, sectionGapPt: 8, entryGapPt: 4 },
      dateFormat: 'MM/YYYY',
    }),
  },
];
